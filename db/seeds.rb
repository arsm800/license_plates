...
state_District_of_Columbia = Location.create(country:"USA", territory: "Washington, D.C.", territory_type: "District")
...
canton_bern = Location.create(country: "Switzerland", territory: "Bern", territory_type: "Canton")

state_chihuahua = Location.create(country: "Mexico", territory: "Chihuahua", territory_type: "State")

province_szechuan = Location.create(country: "China", territory: "Szechuan", territory_type: "Province")

state_new_south_wales = Location.create(country: "Australia", territory: "New South Wales", territory_type: "State")

island_ponape = Location.create(country: "Federated States of Micronesia", territory: "Ponape", territory_type: "Island")

province_herrera = Location.create(country: "Panama", territory: "Herrera", territory_type: "Province")
